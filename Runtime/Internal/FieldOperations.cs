namespace TinyNaCl.Internal
{
    internal static class FieldOperations
    {
        ...
        {
            int i;
            fe_sq(out FieldElement t0, ref z);
            fe_sq(out FieldElement t1, ref t0);
            ...
            fe_sq(out FieldElement t2, ref t0);
            ...
            fe_sq(out FieldElement t3, ref t2);
        ...
        internal static void fe_pow22523(out FieldElement result, ref FieldElement z)
        {
            ...
            fe_sq(out FieldElement t2, ref t1);
